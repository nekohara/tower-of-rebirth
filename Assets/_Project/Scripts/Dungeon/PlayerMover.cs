...
public class PlayerMover : MonoBehaviour
{
    ...
    private bool isEncounterTransitioning;
    ...
    private string[] dungeonMessages =
{
    ...
    private void Update()
    {
        // 戦闘画面へのフェード中は移動・旋回・調べる操作を受け付けない。
        if (isEncounterTransitioning)
        {
            return;
        }
...
private void TryMove(Vector3 direction)
    ...
    private IEnumerator EncounterRoutine()
    {
        ...
        // 最初のyieldより前にロックし、次フレームから入力を停止する。
        isEncounterTransitioning = true;
